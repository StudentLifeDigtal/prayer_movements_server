  ...
  module Concerns
    module APIGuard
      ...
      module HelperMethods
        ...
        #
        # If the token does not have scope to cover the required scopes,
        ...
        def guard!(scopes: [])
          ...
          if token_string.blank?
            ...
            when Oauth2::AccessTokenValidationService::INSUFFICIENT_SCOPE
              fail InsufficientScopeError.new(scopes)
        ...
        def validate_access_token(access_token, scopes)
          Oauth2::AccessTokenValidationService.validate(access_token,
                                                        scopes: scopes)
        end
      end
          ...
          Proc.new do |e|
            ...
            when InsufficientScopeError
              Rack::OAuth2::Server::Resource::Bearer::Forbidden.new(
                ...
                ErrorMethods::DEFAULT_DESCRIPTION[:insufficient_scope],
                scope: e.scopes)
            end
